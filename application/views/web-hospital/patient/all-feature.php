                ...
                <div class="modal-body">
                    ...
                    <div class="row mb-2">
                        <div class="col-md-1 pt-1">
                            <input type="checkbox" class="form-control due-amt-check" checked="true">
                        </div>
                        <div class="col-md-6">Due amount should be 0.00</div>
                    </div>
                    ...
                    <div class="row border border-warning rounded mb-3 afterDis" style="display: none;">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label class="form-label">Total Amount</label>
                                <input type="number" class="form-control accTotal accDisTotal" readonly="true">
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label class="form-label">Paid Amount</label>
                                <input type="number" class="form-control accPaid" readonly="true">
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label class="form-label">Due Amount</label>
                                <input type="number" class="form-control accDue accDisDue" readonly="true">
                            </div>
                        </div>
